...
$rand = rand(1,100);
$requestOption = $_REQUEST['option'] ?? '';
$backgroundImage = ($requestOption == 'sport-complex-form') ? 'background-image: url(images/sport-bg.png) !important;' : '';
$CurrentLang = $CurrentLang ?? ($_SESSION['LANGUAGE'] ?? 'en');
$StoreName = (isset($StoreName) && is_array($StoreName)) ? $StoreName : ['', '#'];
$Facebook = $Facebook ?? '#';
$Twitter = $Twitter ?? '#';
$Instagram = $Instagram ?? '#';
$Title = $Title ?? '';
$popitems = $popitems ?? '';
$PopActive = $PopActive ?? 0;
$SliderActive = $SliderActive ?? 0;
?>
<!DOCTYPE HTML>
...
<div class="wrappage" style="<?=$backgroundImage  ?>">
            ...
            <div class="container">
                <div id="navigation">
                    ...
                    <?php
                        $finalnav = '';
                        $CurrentLang = '';
                        $objPages->loadFrontNavigation($CurrentLang,$CURRENT_ACTIVE_INDEX,'ShowInNav',$finalnav,0,0);
                        echo $finalnav;
                    ?>
    ...
    $StoreName = include($currentpage . ".php");
...
<?php
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4">
                        ...
                        <div class="widget no-box">
                            <h4 class="widget-title">Latest Searches <?php echo date("F Y");?></title><span></span></h4>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <p>
                    This page contains information about <?= $StoreName[0] ?> Coupon Codes & Promotions 
                </p>
                <p>
                    <?= date("F Y") ?>
                </p>
...
<?php
if(!isset($_REQUEST['option']) && !isset($_REQUEST['suboption']) && empty($_SESSION['popupview'.LANG_SEP_DB])){
