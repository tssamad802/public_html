...
if($_SESSION[session_id().'_changeP'] == '')
{
	redirect('index.php',0);
}
$_SESSION[session_id().'_changeP'] = '';
?>
...
<div class="container"> 
    ...
    <div class="headergap"></div> 
    	...
    	<div class="hk-pg-header mb-0 headerboxdesign"> 
             <h4 class="hk-pg-title" id="titleheading"><?=CHANGE_PASS?></h4> 
        </div> 
                ...
                <section class="hk-sec-wrapper">
                    <div class="row">
                        <div class="col-sm">
                            ...
                            <input type="hidden" name="ChangePassUserID" value="<?=encodeencriptstring($_REQUEST['UserID'])?>" /> 
