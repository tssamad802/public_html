...
if (isset($_REQUEST['FireAction']) && $_REQUEST['FireAction'] == 'listingcampaigns') {
   ...
   <script>
if (typeof window.UpdateActive !== 'function') {
    window.UpdateActive = function(Active, id) {
        // your existing code ...
        if(Active == "No")
            Active = 1;
        else
...
if (typeof window.UpdateCouponActive !== 'function') {
    window.UpdateCouponActive = function(Active, id) {
        // your existing code ...
        if(Active == "No")
            Active = 1;
        else
