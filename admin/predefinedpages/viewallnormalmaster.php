                        ...
                        <div class="col-sm">
                            <div class="form-row">
                                <div class="col-md-4 mb-10">
                                    ...
                                    <input type="text" name="<?=($RecordID==0)?'Title[]':'Title'?>" id="Title" onkeyup="<?=($FetchData['Title']!='') ? '' : 'BuildURL()'?>" class="form-control" value="<?=$FetchData['Title']?>" dir="ltr" id="DomainName" <?php if($FetchData['Title']=="") {?>onkeyup='BuildURL();'<?php } ?>   required />
                                ...
                                <?php if($_REQUEST['SubLinkID']==26){?>
                                    <div class="col-md-4 mb-10">
                                        ...
                                        <input type="text" name="CountryTag" class="form-control" value="<?=$FetchData['CountryTag']?>" required />
                                        <div class="invalid-feedback">
                                            Please enter title
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-10">
                                        ...
                                        <input type="text" name="CountryKeyword" class="form-control" value="<?=$FetchData['CountryKeyword']?>" required />
                                        <div class="invalid-feedback">
                                            Please enter title
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-10">
                                        ...
                                        <input type="text" name="Currency" class="form-control" value="<?=$FetchData['Currency']?>" required />
                                        <div class="invalid-feedback">
                                ...
                                <?php if($_REQUEST['SubLinkID']==37){?>
                                    <div class="col-md-8 mb-10">
                                        ...
                                        <input type="text" name="URL" id="URL" readonly class="form-control" value="<?=$FetchData['URL']?>" required />
                                    </div>
                                <?php } ?>
                                   ...
                                   <!--  <div class="col-md-6 ">
                                    ...
                                    <div class="col-md-4">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="custom-control custom-radio mb-10 mt-10">
                                                        <input id="Yes1" name="ShowHome" class="custom-control-input" <?=($FetchData['ShowHome']==1)?'checked="checked"':''?>   type="radio" value="1">
                                                        <label class="custom-control-label" for="Yes1"><?=TXT_YES?></label>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="custom-control custom-radio mb-10 mt-8 ml-20 mr-20">
                                                        <input id="No1" name="ShowHome" class="custom-control-input" <?=($FetchData['ShowHome']==0)?'checked="checked"':''?>  type="radio"  value="0">
                                                        <label class="custom-control-label" for="No1"><?=TXT_NO?></label>
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            ...
                                            <input type="text" name="tagDate" class="form-control singleDatePicker" value="<?=($FetchData['tagDate']=="0000-00-00")?'':$FetchData['tagDate']?>" readonly="readonly"  required />
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-6 col-lg-6">
                                            ...
                                            <input type="text" name="URLKeyword" class="form-control" id="URLKeyword" value="<?=$FetchData['URLKeyword']?>"  />
                                        </div>
...
<!--                                    </div>-->
                                ...
                                <?php if($_REQUEST['SubLinkID']==32){?>
                                    <div class="col-md-4 mb-10">
                                        ...
                                        <input type="text" name="NetID" class="form-control" value="<?=$FetchData['NetID']?>" required />
                                        <div class="invalid-feedback">
                                            Please enter title
                                        </div>
                                    </div>
                                    <div class="col-md-4 mb-10">
                                        ...
                                        <input type="text" name="NetDeepLinkCode" class="form-control" value="<?=$FetchData['NetDeepLinkCode']?>" />
                                        <div class="invalid-feedback">
                                            Please enter title
                                        </div>
                                    </div>
                        ...
                        ?>
                            <div class="form-row">
                                    <?php if($RecordID==0) { ?>
                                    <div class="col-md-6 mb-10">
                                        <a href="javascript:void(0);" class="addplussign" style="display:block;color:#000;font-size:30px;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12 mb-10">
                                                ...
                                                <input type="text" name="URLKeyword" id="URLKeyword" value="<?=$FetchData['URLKeyword']?>" id="URLKeyword" readonly class="form-control" />
                                                <div class="invalid-feedback">
                                                    <?=ERROR_PAGE_URL?>
                                                </div>
