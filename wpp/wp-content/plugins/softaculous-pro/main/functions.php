...
function softaculous_pro_load_plugin(){
	...
	if(current_user_can('administrator')){
		...
		add_action('wp_ajax_softaculous_pro_generate_post', 'softaculous_pro_templates_ajax');

		add_action('wp_ajax_softaculous_switch_template_mode', 'softaculous_pro_templates_ajax');
		add_action('wp_ajax_softaculous_pro_ai_autocomplete', 'softaculous_pro_templates_ajax');
		add_action('wp_ajax_softaculous_pro_search_images', 'softaculous_pro_templates_ajax');
		add_action('wp_ajax_softaculous_pro_cache_iframe_urls', 'softaculous_pro_templates_ajax');
		add_action('wp_ajax_softaculous_pro_stream_iframes', 'softaculous_pro_templates_ajax');
		
		// Setup information
		add_action('wp_ajax_softaculous_pro_setup_info', 'softaculous_pro_templates_ajax');
		add_action('wp_ajax_softaculous_pro_ai_description', 'softaculous_pro_templates_ajax');
		add_action('wp_ajax_softaculous_pro_get_setup_info', 'softaculous_pro_templates_ajax');
...
function softaculous_pro_templates_ajax() {
	...
	if($_REQUEST['action'] == 'softaculous_pro_generate_post'){
		softaculous_pro_ajax_generate_post();
	}
	...
	if($_REQUEST['action'] == 'softaculous_pro_ai_description'){
		softaculous_pro_ai_description();
	}
	
	if($_REQUEST['action'] == 'softaculous_pro_get_setup_info'){
		softaculous_pro_get_setup_info();
	}
	...
	if ($_REQUEST['action'] == 'softaculous_switch_template_mode') {
	...
	if($_REQUEST['action'] == 'softaculous_pro_ai_autocomplete'){
		softaculous_pro_ai_autocomplete();
	}
	
	if($_REQUEST['action'] == 'softaculous_pro_search_images'){
		softaculous_pro_search_images();
	}
	
	if($_REQUEST['action'] == 'softaculous_pro_cache_iframe_urls'){
		softaculous_pro_cache_iframe_urls();
	}
	
	if($_REQUEST['action'] == 'softaculous_pro_stream_iframes'){
		softaculous_pro_stream_iframes();
	}
