...
// Customize the consent banner (if needed)
add_filter('cookieadmin_consent_banner_template', '\CookieAdminPro\Enduser::consent_banner', 10, 1);
...
function cookieadmin_pro_load_plugin(){
	...
	if(!empty($cookieadmin_settings['google_consent_mode_v2'])){
		add_action('wp_head', '\CookieAdminPro\Enduser::wp_head', 5);
	}
