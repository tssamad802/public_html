		...
		<div id="menu-locations-wrap">
			<form method="post"
							...
							<tr class="menu-locations-row">
								...
								<td class="menu-location-menus">
									<select name="menu-locations[<?php echo $_location; ?>]"
										...
										<option value="0">
											<?php printf('&mdash; %s &mdash;', esc_html__('Select a Menu')); ?></option>
										<?php
				...
				<p class="button-controls wp-clearfix">
					<?php submit_button(__('Save Changes'), 'primary left', 'nav-menu-locations', false); ?></p>
		...
		<div class="manage-menus">
			...
			<?php else: ?>
				<form method="get" action="<?php echo esc_url(admin_url('nav-menus.php')); ?>">
					...
					<span class="submit-btn"><input type="submit" class="button"
							...
							<div id="nav-menu-header">
								<div class="major-publishing-actions wp-clearfix">
									...
									<input name="menu-name" id="menu-name" type="text"
										class="menu-name regular-text menu-item-textbox form-required" required="required"
										<?php echo $menu_name_val . $menu_name_aria_desc; ?> />
								...
								<div id="post-body-content" class="wp-clearfix">
									...
									<?php if ($add_new_screen): ?>
										<p class="post-body-plain" id="menu-name-desc">
											<?php _e('Give your menu a name, then click Create Menu.'); ?></p>
									...
									<div class="menu-settings" <?php echo $no_menus_style; ?>>
										...
										<fieldset class="menu-settings-group auto-add-pages">
											<legend class="menu-settings-group-name howto"><?php _e('Auto add pages'); ?>
											</legend>
										...
										<?php if (current_theme_supports('menus')): ?>
											...
											<fieldset class="menu-settings-group menu-theme-locations">
												<legend class="menu-settings-group-name howto">
													<?php _e('Display location'); ?></legend>
												<?php
												foreach ($locations as $location => $description):
													$checked = false;
