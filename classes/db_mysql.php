...
/*		Creation Date		:	21-4-2007					*/
/*		Mobile Number		:	00971-50-8912116			*/
/*		Mobile Number		:	00971-55-4205000			*/
/*		Email Address		:	shehzad_preston@hotmail.com	*/
class DB_Sql
{
    ...
    function MysqlInsertID()
    {
        ...
        $this->Query_ID = mysqli_insert_id($this->Link_ID);
        $this->Row = 0;
        $this->Errno = mysqli_errno($this->Link_ID);
        $this->Error = mysqli_error($this->Link_ID);
        if (!$this->Query_ID) {
            //$this->halt("Invalid SQL: ".$Query_String);
            $this->halt("Invalid Data");
        }
